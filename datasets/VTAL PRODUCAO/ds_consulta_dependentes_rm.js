function createDataset(fields, constraints, sortFields) {
	...
	var codConsulta = getConstraint(constraints, "codConsulta");
	var codSistema = 'P';
	var codcoligada = 0;
	...
	if (codConsulta == 'FLUIG_INTGR01') {
		...
		PARAMS = "USERFLUIG=" + idExterno;
	}

	if (codConsulta == 'FLUIG_INTGR03') {
		var ANOCOMP = parseInt(getConstraint(constraints, "ANOCOMP"));
		var NRODEPEND = parseInt(getConstraint(constraints, "NRODEPEND"));
	
		newDataset.addColumn("TIPOPAGAMENTO");
		newDataset.addColumn("ANOCOMP");
		newDataset.addColumn("TIPOREEMBOLSO");
		newDataset.addColumn("MESCOMP");
		PARAMS = "USERFLUIG=" + idExterno + ";NRODEPEND=" + NRODEPEND+ ";ANOCOMP="+ ANOCOMP;
	}

function createDataset(fields, constraints, sortFields) {
	...
	newDataset.addColumn("PVALETR_NOMELINHA");
	newDataset.addColumn("PVALETR_CODTARIFA");
	newDataset.addColumn("PVALETR_GRUPOTRANSP");
	newDataset.addColumn("PVALETR_TIPOTRANSP");
	newDataset.addColumn("PVALETR_UNICO");
	newDataset.addColumn("PVALETR_CODIGO");
	newDataset.addColumn("PVALETR_ATIVO");
	newDataset.addColumn("PVALETR_NOMELINHA");
	newDataset.addColumn("PTARIFA_CODIGO");
	newDataset.addColumn("PTARIFA_DESCRICAO");
	newDataset.addColumn("PTARIFA_VALOR");
	newDataset.addColumn("PTARIFA_FINALVIGENCIA");
	...
	try {
		...
		result = authService.realizarConsultaSQL(codConsulta, codcoligada, codSistema, '');
